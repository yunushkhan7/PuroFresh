...
export class ReportsComponent2 implements OnInit {
  ...
  public getdata(sd,ed){
    this.partneshipService.getAlldetailsforreport(sd,ed).subscribe(data => {
      console.log(data);
      this.data2 = data;
      this.totalsalesamount = this.data2.totalPayoutAmount
      this.data2 = this.data2.transactions
    })
  }
